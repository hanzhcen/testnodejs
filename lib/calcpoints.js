...
////        SWITCH      ////
var enableTransactionPart = true;
var enablePointSchemePart = false;
var enableCampaignPart = false;
        ...
        try{
            ...
            for(var i=0;i<transaction_list.length;i++){
                try{
                    ...
                    if(pointsscheme_list.length > 0){
                        for (var j=0;j<pointsscheme_list.length;j++){
                            ...
                            if(earnedPoints > 0){
                                ...
                                querystring = "UPDATE loyaltycore.ivls__transaction__c " + " SET ivls__pointsearned__c = "+perTransaction_PointsEarned+", ivls__pointsnet__c = "+ perTransaction_PointsEarned + ",ivls__pointsbasic__c = "+perTransaction_PointsEarned+", ivls__datepointsexpiry__c = "+router.AddSingleQuoteSymbol(expiryDATE) +", ivls__activity__c = '"+productCate.name+"' WHERE id = " + transactionObj.id; 
                                querystring_list.push(querystring);
                            }
                        }
                    }
                    ...
                    querystring = "UPDATE loyaltycore.ivls__transaction__c " + " SET ivls__transactiondate__c = NOW() - interval '8 hours', ivls__pointsearned__c = "+perTransaction_PointsEarned+", ivls__pointsnet__c = "+ perTransaction_PointsEarned + ",ivls__pointsbasic__c = "+perTransaction_PointsEarned+", ivls__datepointsexpiry__c = "+router.AddSingleQuoteSymbol(expiryDATE) +", ivls__activities__c = '"+productCate.name+"' WHERE id = " + transactionObj.id; 
                    querystring_list.push(querystring);
                    ...
                    InsertObj.ivls__activity__c = productCate.name;
