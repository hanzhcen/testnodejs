...
async function gentransactions (processDate,environment, log_level) {
    try{
        ...
        querystring =  "SELECT  * FROM loyaltycore.ivls__transactionlog__c WHERE (LOWER(ivls__transactiontype__c) = 'pos' OR LOWER(ivls__transactiontype__c) = 'eshop') AND LOWER(ivls__status__c) = 'open' AND createddate>='2018/09/24' ORDER BY id;";
