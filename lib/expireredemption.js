        ...
        for (var i=0; i<redemption_list.length;i++){
            ...
            for(var j=0;j<matched_detail_list.length;j++){
                ...
                for(var k=0;k<matched_transaction_list.length;k++){
                    ...
                    querystring =  'UPDATE loyaltycore.ivls__transaction__c SET ivls__pointsredeemed__c = '+ new_ivls__pointsredeemed__c +', ivls__pointsredeeming__c = '+new_ivls__pointsredeeming__c+'  WHERE id = '+matched_transaction_list[i].id;
